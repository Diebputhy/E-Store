...
function Form() {
  return (
    <>
      ...
      <h1 className='mb-3 text-2xl text-center text-white mt-6'>Contact Us</h1>
        ...
        <div className="flex flex-wrap -mx-3 mb-2">
          <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            <label className="block uppercase tracking-wide text-gray-100 text-xs font-bold mb-2" htmlFor="grid-city">
              City
            </label>
            <input
              className="appearance-none block w-full bg-gray-200 text-gray-100 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
          ...
          <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            <label className="block uppercase tracking-wide text-gray-100 text-xs font-bold mb-2" htmlFor="grid-state">
              State
            </label>
        ...
        <button className='bg-green-500 mt-8 w-[100px] h-12 rounded-xl  text-xl flex items-center justify-center hover:bg-red-500'>
          Sent
          <BiSend className='ml-2 mt-1'/>
        </button>
      </form>
    </>
  );
