...
function NewArrival() {
    ...
    return (
        <div className='w-screen  overflow-hidden md:h-[500px] px-8  mt-7'>
            <h1 className='text-2xl md:text-4xl text-black font-serif mb-10'>New Arrivals</h1>
            <div className='w-full h-[80%] block md:flex justify-between'>
                {
                    data.map((value, key) => (
                        <div className=' w-full md:w-[19%] relative '>
                            <div className='w-full h-[50%] md:h-[75%] bg-slate-200 '>
                                <Image src={value.img} alt="Man" width={500} height={500} className='hover:transform-gpu hover:scale-105' />
                            </div>
                            <div className='w-full h-[25%]mt-0 md:mt-3 '>
